import type { RecItem, RecQuestion } from '@/features/recommendations/engine';

export const BANK_PROFILES: Record<string, { key: string; title: string }> = {
...
export const BANK_QUESTIONS: RecQuestion[] = [
  {
    id: 'q1',
    category: 'Profil',
