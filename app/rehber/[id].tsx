...
const styles = StyleSheet.create({
  ...
  name: { fontSize: fontSize.xxl, fontWeight: fontWeight.bold, color: colors.gray900, textAlign: 'center' },
  category: { fontSize: fontSize.sm, color: colors.gray500, textAlign: 'center', marginTop: spacing.xs },
  field: { marginTop: spacing.lg },
  fieldLabel: { fontSize: fontSize.sm, color: colors.gray500, fontWeight: fontWeight.medium },
  fieldValue: { fontSize: fontSize.md, color: colors.gray800, marginTop: spacing.xs },
