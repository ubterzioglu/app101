...
export default function HolidayDEScreen() {
  ...
  function handleCalculate() {
    ...
    if (e < s) return;
    setResult(calculateDERange(s, e, state));
  }
          ...
          <>
            ...
            {result.holidayHits.length > 0 ? (
              ...
              <AppCard accentColor={colors.border}>
                <Text style={styles.noHits}>Bu aralıkta Almanya resmî tatili yok.</Text>
              </AppCard>
            )}

            <Text style={styles.note}>
              Almanya 2026 tatilleri seçili eyalete ({state}) göre hesaplanmıştır.
