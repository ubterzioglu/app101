...
const styles = StyleSheet.create({
  ...
  statNumber: { fontSize: fontSize.xxl, fontWeight: fontWeight.bold, color: colors.blue },
  ...
  subCategory: { fontSize: fontSize.xs, color: colors.green, fontWeight: fontWeight.medium, marginTop: 2 },
  ...
  actionPrimaryText: { color: colors.white, fontWeight: fontWeight.semibold, fontSize: fontSize.sm },
  actionSecondary: {
    flex: 1,
    borderWidth: 1,
  ...
  actionSecondaryText: { color: colors.gray600, fontWeight: fontWeight.medium, fontSize: fontSize.sm },
});
