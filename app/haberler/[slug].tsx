...
const styles = StyleSheet.create({
  ...
  category: { color: colors.accent, fontWeight: fontWeight.semibold, fontSize: fontSize.sm },
  title: {
  ...
  sourceMeta: { fontSize: fontSize.xs, color: colors.textSecondary, marginTop: spacing.xs },
  excerpt: {
  ...
  sourceLabel: { fontSize: fontSize.sm, color: colors.textSecondary, fontWeight: fontWeight.medium },
