...
const IGNORED_CONTENT_SCAN = new Set([
  ...
  // archive/ altına taşındılar; muafiyet yolları yeni konuma göre güncellendi.
  'archive/almanya101_app101_repo_google_play_prompt.md',
  'archive/almanya101_google_play_kisisel_hesap_adim_adim.md',
]);
