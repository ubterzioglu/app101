// Ported from last101 belge kataloğu. Public static catalogue for native screens.
    ...
    documents: [
      {
        ...
        supportingDocs:
          'Kimlik/pasaport; kira sözleşmesi; **Wohnungsgeberbestätigung** (ev sahibi formu).',
    ...
    documents: [
      {
        ...
        who: 'A+B.',
        supportingDocs:
          'Genellikle otomatik atanır; kayıp/yeniden bildirim için kimlik ve kayıt bilgileri gerekir.',
        authority:
          'Sistematik atama Meldebehörde kaydı sonrası yapılır; bilgilendirme vergi idaresi üzerinden gelir.',
        duration:
          'İlk atama/tebliğ süresi yerel süreç ve posta akışına bağlı (eyalete göre değişir).',
        cost: 'Yok.',
      },
      {
    ...
    documents: [
      {
        ...
        supportingDocs:
          'Krankenkasse üyeliği; kimlik; fotoğraf (kural/istisna sigortaya göre).',
        authority: 'Krankenkasse (GKV/özel).',
        duration:
          'Üyelik tamamlanınca kartın basım/posta sürecine bağlı (eyalete göre değişir).',
    ...
    documents: [
      {
        ...
        supportingDocs:
          'Biyometrik foto; kimlik doğrulama; önceki kimlik/pasaport (duruma göre).',
      ...
      },
      {
        ...
        duration:
          'Başvurudan sonra **genellikle en az 2 hafta** (yerel yoğunlukta daha uzun olabilir).',
        cost:
          '**24+ yaş 70 €**, **24 yaş altı 37,50 €**; Express için **32 €** ek ücret olabilir.',
      },
      {
        ...
        who:
          'B (Alman vatandaşıysa) + A (Alman vatandaşlığına geçtiyse) – acil ihtiyaca göre.',
    ...
    documents: [
      {
        ...
        supportingDocs:
          'Vize türüne göre değişir (ör. aile birleşimi, çalışma, eğitim); başvuruda form ve pasaport temel unsurlardır.',
        authority:
          'Başvuru ülkesindeki Alman dış temsilciliği; çoğu durumda Almanya’daki Ausländerbehörde ve bazen diğer kurumların onayı gerekir.',
        duration:
          'Vize türüne göre **birkaç hafta**, onay gerektiren dosyalarda **3 aya kadar, bazen daha uzun** sürebilir.',
        cost:
          'Ulusal vize için genel ücret **75 €**; bazı çocuk başvurularında **37,50 €** (istisna/ muafiyetler olabilir).',
      },
    ],
  },
  {
    category:
      'Göç ve oturum (Almanya içinde) – A ve Alman vatandaşı olmayan B grubu için çekirdek set',
    documents: [
      {
        ...
        supportingDocs:
          'Pasaport; biyometrik foto; adres kaydı; oturum gerekçesine göre (iş sözleşmesi, aile bağları, eğitim vb.) ek set.',
      ...
      },
      {
        ...
        who:
          'A (nitelikli çalışma ile gelenler) + B (Alman vatandaşı değilse ve koşulları sağlıyorsa).',
        supportingDocs:
          'İş sözleşmesi/teklif; diploma ve/veya denklik; pasaport; foto; (gerekirse) diğer kurum onayları.',
        authority: 'Ausländerbehörde.',
        duration: 'Eyalete göre değişir; eAT üretim süreci etkiler.',
        cost:
          'Tipik idari ücret **100 €**; bazı özel durumlarda azaltılmış ücret uygulamaları olabilir.',
      },
      {
        ...
        supportingDocs:
          'Uzun süreli ikamet/gelir/entegrasyon kanıtları (dosya türü: eyalete göre değişir).',
        authority: 'Ausländerbehörde.',
      ...
      },
      {
        ...
        who: 'A + B (Alman vatandaşı değilse, şartları sağlarsa).',
        supportingDocs:
          'İkamet süresi, geçim güvencesi vb. kanıtlar (eyalete göre değişir).',
        authority: 'Ausländerbehörde.',
        duration: 'Eyalete göre değişir.',
      ...
      },
      {
        ...
        who:
          'A + B (Alman vatandaşı değilse; uzatma/yenileme sürecinde).',
        supportingDocs:
          'Başvuru kanıtı; pasaport; mevcut oturum kartı (varsa).',
        authority: 'Ausländerbehörde.',
        duration:
          'Örnek federal hizmet tanımında “yaklaşık 5 hafta” verilmiştir (eyalete göre değişir).',
        cost:
          'Örnek federal hizmet tanımında **13 €** verilmiştir (uygulama eyalete göre değişir).',
      },
      {
        ...
        supportingDocs:
          'Genelde eAT ile birlikte verilir; değişiklik talebinde gelir/iş/yaşam durumu kanıtları istenir.',
        authority: 'Ausländerbehörde.',
    ...
    documents: [
      {
        ...
        supportingDocs:
          'Başvuruya göre; ebeveyn kimlikleri; evlilik kaydı veya annenin doğum belgesi gibi evraklar (duruma göre).',
        authority: 'Standesamt (doğum yerindeki).',
        duration:
          'Yeni doğum kaydı sonrası Standesamt akışına bağlı; sonradan “Urkunde” talebi posta/online sürecine bağlı (eyalete göre değişir).',
        cost:
          'Eyalete göre değişir; örnek portallarda 15–20 € bantları görülür, sosyal amaçlı bazı nüshalar ücretsiz olabilir.',
      },
      {
        ...
        supportingDocs:
          'Kayıtlı olduğu Standesamt bilgisi; kimlik; yetkilendirme/vekâlet (başkasının alması halinde).',
        authority: 'Standesamt (evliliğin tescil edildiği yer).',
        duration:
          'Kayıt yeri belliyse genelde kısa; kayıt yeri bilinmiyorsa arama süreci aylar sürebilir (örnek: 8 aya kadar).',
        cost:
          'Eyalete göre değişir; sık görülen örnek ücret 10 € (ek nüsha 5 €) olsa da belediyeye göre farklı tarife olabilir.',
      },
      {
        ...
        supportingDocs:
          'Yabancı mahkeme kararı, kesinleşme şerhi, tercüme/apostil/diğer kanıtlar (dosya ülkeye göre değişir).',
        authority:
          'Eyalet adlî idaresi / pratikte çoğu yerde Oberlandesgericht üzerinden yürür (eyalete göre değişir).',
        duration:
          'Yaklaşık 3–4 ay örneklenir; dosya karmaşıklığına göre değişebilir (eyalete göre değişir).',
        cost:
          'Gelire bağlı çerçeve ücret örnekleri **15–305 €** bandı; başvuru kanalı (Standesamt üzerinden) ek ücrete yol açabilir.',
      },
      {
      ...
      },
      {
        ...
        supportingDocs:
          'Ebeveyn kimlik belgeleri; (sonradan yapılırsa) çocuğun doğum belgesi gibi evraklar.',
        authority: 'Jugendamt veya noter (kamusal beyan şartı).',
        duration: 'Randevuya bağlı (eyalete göre değişir).',
        cost: 'Jugendamt üzerinden genellikle ücretsiz; noter ücretli olabilir.',
      },
    ],
  },
  {
    ...
    documents: [
      {
        ...
        supportingDocs:
          'Başvuruda ebeveyn ve çocukların Steuer-ID’leri; çocukla ilişki ve ikamet kanıtları (dosya türü değişebilir).',
        authority: 'Familienkasse.',
        duration:
          'Bölgesel farklı; örnek resmi bilgi “genelde 4–6 hafta” olarak verilir (eyalete göre değişir).',
      ...
      },
      {
        ...
        duration:
          'Şehre göre değişir; örnek belediye bilgisinde **6–8 hafta** verilmiştir (eyalete göre değişir).',
      ...
      },
      {
        ...
        supportingDocs:
          'Geburtsurkunde; varsa Vaterschaftsanerkennung ve Unterhaltstitel; kimlik/oturum kartı (özellikle yabancılar için) gibi evraklar.',
    ...
    documents: [
      {
        ...
        supportingDocs:
          'Kimlik doğrulama; online başvuruda eID/BundID ile doğrulama seçenekleri (yönteme göre).',
        authority: 'Federal sistem üzerinden; başvuru online veya belediye üzerinden yapılabilir.',
        duration:
          'Posta ve işlem akışına bağlı (eyalete göre değişir); pratikte birkaç iş günü–hafta ölçeğinde planlanır.',
        cost: '**13 €**.',
      },
    ],
  },
    ...
    documents: [
      {
        ...
        who:
          'A (Türkiye’den ehliyetle gelenler) + B (ehliyeti Türkiye’den aldıysa).',
        supportingDocs:
          'Kimlik/pasaport; Meldebestätigung; yabancı ehliyet aslı + tercüme; biyometrik foto; gerekirse ilk yardım ve diğer yerel kanıtlar.',
        authority: 'Fahrerlaubnisbehörde (şehir/kaymakamlık düzeyi).',
        duration: 'Başvuru ve sınav planlamasına bağlı (eyalete göre değişir).',
        cost:
          'İdari ücretler belediyeye göre değişir (örnek tarifelerde ~55–58 € bandı görülür; sınav ücretleri ayrıca).',
        note:
          '(Türkiye “Anlage 11” listesinde yok):** Federal bakanlık merkblatt’ında “Anlage 11” ülkeleri listelenir; listede Türkiye bulunmadığı için genel kural olarak teorik + pratik sınav gerekliliğiyle karşılaşılır (tam şartlar yerel makamca teyit edilir).',
      },
    ],
  },
  {
    ...
    documents: [
      {
        ...
        who:
          'A (vatandaşlığa geçmek isteyenler) + B (Alman vatandaşı değilse ve sonradan geçecekse).',
        supportingDocs:
          'Başvuru dosyası; entegrasyon/gelir/kimlik vb. (eyalete göre değişir).',
        authority: 'Einbürgerungsbehörde (belediye/ilçe).',
        duration:
          'Yerel iş yükü çok değişken; örnek bir belediyede randevu bekleme 12 ay ve başvuru sonrası işleme 16 aya kadar uzayabilir şeklinde ilan edilmiştir (eyalete göre değişir).',
        cost:
          'Genel çerçevede yetişkin için **255 €**, birlikte vatandaş olan reşit olmayan çocuk için **51 €** düzeyi resmî ücret tablolarında geçer.',
      },
      {
        ...
        supportingDocs:
          'Soy bağı/kimlik/önceki statü belgeleri (dosya çok değişken).',
        authority: 'Başvuru kanalı yerel olabilir; karar ve ücret yapısı federal düzeyde tariflenir.',
        duration:
          'Dosyaya göre çok değişken; resmî bilgi “çok farklı, sıklıkla ek araştırma gerekir” şeklindedir.',
        cost: '**51 €**.',
      },
    ],
  },
    ...
    documents: [
      {
        ...
        supportingDocs:
          'Kurs katılımı; DTZ (A2/B1) ve “Leben in Deutschland” testinin başarıyla geçilmesi.',
        authority: 'Kurs/sınav altyapısı BAMF sistemiyle yürür; sertifika test başarısı sonrası oluşur.',
        duration:
          'Sınav sonucu/sertifika akışı; örnek rehberde sonuçların ~8 haftada geldiği belirtilir (eyalete göre değişir).',
        cost:
          'Kurs ücretleri statüye göre değişebilir; mesleki dil kurslarında gelir eşiğine göre katkı payı olabilir.',
      },
      {
    ...
    documents: [
      {
        ...
        supportingDocs:
          'Diploma/ transkript ve istenen doğrulama biçimleri (tercüme/beglaubigte Kopie).',
        authority: 'ZAB.',
    ...
    documents: [
      {
        ...
        supportingDocs:
          'T.C. Kimlik Kartı; biyometrik foto; eski pasaport; reşit olmayanlarda ebeveyn hazır bulunması veya muvafakatname gibi ek set.',
        authority: 'T.C. Başkonsolosluğu (konsolosluk randevu sistemi).',
        duration:
          'Örnek resmî duyuruda e-pasaportların Türkiye’de tanzim edilip konsolosluğa **yaklaşık 3 hafta** içinde gönderildiği belirtilir; başka temsilcilikte “yaklaşık 1 ay” ifadesi de vardır (yoğunluğa göre değişebilir).',
        cost:
          'Konsolosluk bilgi notlarında yıl bazında güncellenen harç + defter + posta bedelleri verilir (örnek 2026 tarifesi).',
      },
      {
        ...
        who: 'A+B (Türkiye vatandaşı olanlar).',
        supportingDocs:
          'Biyometrik foto; eski nüfus cüzdanı/kimlik; pasaport/diğer fotoğraflı Türk belgeleri; doğum başvurularında önce doğum kaydı şartı vurgulanır.',
        authority: 'T.C. Başkonsolosluğu (konsolosluk randevu sistemi).',
        duration:
          'Kimlik kartı Türkiye’de basılıp temsilciliğe gönderilir; örnek uygulamada bildirim gelmezse **45 gün sonra** durum sorulabileceği, bildirimden sonra kartın **en geç 3 ay içinde** teslim alınması gerektiği belirtilir (temsilciliğe göre değişebilir).',
        cost:
          'Temsilcilik ve işlem türüne göre değişebilir (kurumlar ücret tabloları yayınlar); bu raporda tek tip tutar verilmemiştir.',
      },
      {
        ...
        supportingDocs:
          'Doğum belgesi ve ebeveyn kimliği gibi evrak seti (temsilciliğe göre değişir).',
      ...
      },
      {
        ...
        supportingDocs:
          'Ebeveyn kimlikleri; velayet durumunu gösteren kararlar; konsolosluk uygulamasına göre ek evrak.',
    ...
    documents: [
      {
        ...
        who:
          'A+B (özellikle Türkiye belgesi Almanya’da veya Almanya belgesi Türkiye’de kullanılacaksa).',
        supportingDocs:
          'Apostil, belgenin **orijinali** üzerinden verilir; hangi ülkede kullanılacağına göre “apostil mi legalizasyon mu” kararı verilir.',
        authority:
          'Belgeyi düzenleyen ülkenin yetkili apostil makamı; Almanya’da hangi makamların apostil verdiği eyalete göre değişir.',
      ...
      },
      {
        ...
        purpose:
          'Türkiye’den alınan belgeyi Almanya’da (veya tersini) resmî işlemlerde kullanılabilir hale getirmek; çoğu makam “yeminli/ermächtigte” tercüman şartı arar.',
        who: 'A+B (TR↔DE belgeleri kullanan herkes).',
        supportingDocs: 'Tercümesi yapılacak belgenin aslı veya talep edilen format.',
        authority:
          'Çeviri bir “makam” değil; ancak yeminli tercüman listeleri adlî idare veri tabanlarında tutulur.',
