...
const styles = StyleSheet.create({
  ...
  summary: { fontSize: fontSize.sm, color: colors.textSecondary, marginTop: spacing.xs, textAlign: 'center' },
  bold: { fontWeight: fontWeight.bold, color: colors.textPrimary },
  correctText: { fontWeight: fontWeight.bold, color: colors.success },
  ...
  badgeCorrectText: { color: colors.success, fontWeight: fontWeight.semibold, fontSize: fontSize.sm },
  badgeWrongText: { color: colors.error, fontWeight: fontWeight.semibold, fontSize: fontSize.sm },
  ...
  passText: { color: colors.success, fontWeight: fontWeight.semibold, textAlign: 'center' },
  failText: { color: colors.error, fontWeight: fontWeight.semibold, textAlign: 'center' },
});
